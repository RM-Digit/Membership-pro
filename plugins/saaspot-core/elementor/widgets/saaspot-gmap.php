<?php
/*
 * Elementor SaaSpot Google map Widget
...
class SaaSpot_Gmap extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'vt-saaspot_gmap';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Google map', 'saaspot-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the SaaSpot Google map widget depended on.
	...
	*/
	...
	/**
	 * Register SaaSpot Google map widget controls.
	...
	*/
	protected function _register_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Map Settings', 'saaspot-core' ),
			]
		);
		$this->add_control(
			'gmap_type',
			[
				'label' => __( 'Google Map Type', 'saaspot-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'ROADMAP' => esc_html__( 'ROADMAP', 'saaspot-core' ),
					'SATELLITE' => esc_html__( 'SATELLITE', 'saaspot-core' ),
					'HYBRID' => esc_html__( 'HYBRID', 'saaspot-core' ),
					'TERRAIN' => esc_html__( 'TERRAIN', 'saaspot-core' ),
				],
				'default' => 'ROADMAP',
			]
		);
		$this->add_control(
			'gmap_style',
			[
				'label' => __( 'Google Map Style', 'saaspot-core' ),
				'type' => Controls_Manager::SELECT,
				'condition' => [
					'gmap_type' => 'ROADMAP',
				],
				...
				'options' => array_flip([
					__( 'Select Style', 'saaspot-core' ) => '',
					__( 'Gray Scale', 'saaspot-core' ) => "gray-scale",
					__( 'Mid Night', 'saaspot-core' ) => "mid-night",
					__( 'Black', 'saaspot-core' ) => "black-road",
					__( 'Blue Water', 'saaspot-core' ) => 'blue-water',
					__( 'Light Dream', 'saaspot-core' ) => 'light-dream',
					__( 'Pale Dawn', 'saaspot-core' ) => 'pale-dawn',
					__( 'Apple Maps-esque', 'saaspot-core' ) => 'apple-maps',
					__( 'Blue Essence', 'saaspot-core' ) => 'blue-essence',
					__( 'Unsaturated Browns', 'saaspot-core' ) => 'unsaturated-browns',
					__( 'Paper', 'saaspot-core' ) => 'paper',
					__( 'Midnight Commander', 'saaspot-core' ) => 'midnight-commander',
					__( 'Light Monochrome', 'saaspot-core' ) => 'light-monochrome',
					__( 'Flat Map', 'saaspot-core' ) => 'flat-map',
					__( 'Retro', 'saaspot-core' ) => 'retro',
					__( 'becomeadinosaur', 'saaspot-core' ) => 'becomeadinosaur',
					__( 'Neutral Blue', 'saaspot-core' ) => 'neutral-blue',
					__( 'Subtle Grayscale', 'saaspot-core' ) => 'subtle-grayscale',
					__( 'Ultra Light with Labels', 'saaspot-core' ) => 'ultra-light-labels',
					__( 'Shades of Grey', 'saaspot-core' ) => 'shades-grey',
				]),
				'default' => 'gray-scale',
			]
		);
		$this->add_control(
			'zoom',
			[
				'label' => esc_html__( 'Zoom', 'saaspot-core' ),
		...
		$this->add_control(
			'gmap_common_marker',
			[
				'label' => esc_html__( 'Common Marker', 'saaspot-core' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
				'description' => esc_html__( 'Upload your custom marker.', 'saaspot-core'),
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->add_control(
			'gmap_scroll_wheel',
			[
				'label' => esc_html__( 'Scroll Wheel', 'saaspot-core' ),
		...
		$this->add_control(
			'gmap_street_view',
			[
				'label' => esc_html__( 'Street View Control', 'saaspot-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'saaspot-core' ),
				'label_off' => esc_html__( 'No', 'saaspot-core' ),
				'return_value' => 'false',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Map Type Control', 'saaspot-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'saaspot-core' ),
				'label_off' => esc_html__( 'No', 'saaspot-core' ),
				'return_value' => 'false',
		...
		$this->start_controls_section(
			'section_map_pins',
			[
				'label' => esc_html__( 'Map Pins', 'saaspot-core' ),
			]
		);
		...
		$repeater->add_control(
			'latitude',
			[
				'label' => esc_html__( 'Latitude', 'saaspot-core' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'Find Latitude : <a href="http://www.latlong.net/" target="_blank">latlong.net</a>', 'saaspot-core' ),
			]
		);
		$repeater->add_control(
			'longitude',
			[
				'label' => esc_html__( 'Longitude', 'saaspot-core' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'Find Longitude : <a href="http://www.latlong.net/" target="_blank">latlong.net</a>', 'saaspot-core' ),
			]
		);
		$repeater->add_control(
			'custom_marker',
			[
				'label' => esc_html__( 'Custom Marker', 'saaspot-core' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
				'description' => esc_html__( 'Upload your unique map marker if your want to differentiate from others.', 'saaspot-core'),
				'label_block' => true,
		...
		$repeater->add_control(
			'location_heading',
			[
				'label' => esc_html__( 'Heading', 'saaspot-core' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'locations_groups',
			[
				'label' => esc_html__( 'Locations', 'saaspot-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'location_heading' => esc_html__( 'Item #1', 'saaspot-core' ),
					],
		...
		$this->start_controls_section(
			'section_gmap_style',
			[
				'label' => esc_html__( 'Gmap Options', 'saaspot-core' ),
		...
		$this->add_responsive_control(
			'gmap_height',
			[
				'label' => esc_html__( 'Height', 'saaspot-core' ),
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .saspot-gmapElementor' => 'height: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
		$this->add_control(
	...
	*/
	protected function render() {
		...
		if ($gmap_common_marker) {
		  ...
		  $common_marker = SAASPOT_PLUGIN_ASTS . '/images/map-marker.png';
		}
		...
		$styled_class  = ' saspot-gmapElementor';
		...
		// Map Tab ID
		if ($gmap_id) {
		  $gmap_open = '<div '. $gmap_id .' class="saspot-gmap-tab tab-pane fade">';
		  $gmap_close = '</div>';
		} else {
		  $gmap_open = '';
		  $gmap_close = '';
		...
		echo $gmap_open;
		echo '<div id="map-'. $e_uniqid .'" class="saspot-google-map '. $styled_class .'"></div>';
		echo $gmap_close;
...
Plugin::instance()->widgets_manager->register_widget_type( new SaaSpot_Gmap() );