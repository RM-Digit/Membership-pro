...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'cs-framework' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'cs-framework' ) .'">';
      ...
      esc_html_e( 'Error! Can not load json file.', 'cs-framework' );
