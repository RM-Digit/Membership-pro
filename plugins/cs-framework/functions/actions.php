...
if( ! function_exists( 'cs_set_icons' ) ) {
  function cs_set_icons() {
    ...
    echo '<div id="cs-icon-dialog" class="cs-dialog" title="'. esc_attr__( 'Add Icon', 'cs-framework' ) .'">';
    echo '<div class="cs-dialog-header cs-text-center"><input type="text" placeholder="'. esc_attr__( 'Search a Icon...', 'cs-framework' ) .'" class="cs-icon-search" /></div>';
  ...
  add_action( 'elementor/editor/before_enqueue_scripts', 'cs_set_icons' );
}
