...
class CSFramework_Shortcode_Manager extends CSFramework_Abstract{
  ...
  public function __construct( $options ) {
    ...
    if( ! empty( $this->options ) ) {
      ...
      // Custom Changes - Elementor
      add_action( 'elementor/editor/footer', array( &$this, 'shortcode_dialog' ) );
  ...
  ?>
    <div id="cs-shortcode-dialog" class="cs-dialog" title="<?php esc_attr_e( 'Add Shortcode', 'cs-framework' ); ?>">
      <div class="cs-dialog-header">
        <select class="<?php echo ( is_rtl() ) ? 'chosen-rtl ' : ''; ?>cs-dialog-select" data-placeholder="<?php esc_attr_e( 'Select a shortcode', 'cs-framework' ); ?>">
          <option value=""></option>
          <?php
      ...
      <div class="cs-insert-button hidden">
        <!-- Custom Changes - Elementor - wp-core-ui class div wrap added -->
        <div class="wp-core-ui"><a href="#" class="button button-primary cs-dialog-insert"><?php esc_html_e( 'Insert Shortcode', 'cs-framework' ); ?></a></div>
      </div>
    </div>
  <?php
  }
  ...
  public function shortcode_generator() {
    ...
    if( isset( $shortcode['clone_fields'] ) ) {
      ...
      // Custom Changes - Elementor - wp-core-ui class added
      echo '<div class="cs-clone-button wp-core-ui"><a id="shortcode-clone-button" class="button" href="#"><i class="fa fa-plus-circle"></i> '. $shortcode['clone_title'] .'</a></div>';
